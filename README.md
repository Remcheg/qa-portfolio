...
Это портфолио содержит примеры тестовой документации и практические задания, выполненные в процессе обучения тестированию программного обеспечения (QA).

## 📂 Структура проекта

### 📁 test-cases/
- [registration.md](test-cases/registration.md) — Тест-кейсы для формы регистрации (позитивные и негативные сценарии, граничные значения)
...
- Техники тест-дизайна: анализ граничных значений (Boundary Value Analysis), классы эквивалентности (Equivalence Partitioning)
